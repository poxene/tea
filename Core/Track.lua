...
function Tea_IsTracked(itemID)
  ...
  return Tea_GetDB().trackedItems[itemID] == true
end

function Tea_GetTrackColor()
  local color = Tea_GetDB().track or DEFAULT_COLOR
  return color.r or DEFAULT_COLOR.r, color.g or DEFAULT_COLOR.g, color.b or DEFAULT_COLOR.b
end
...
function Tea_TrackItem(itemID)
  ...
  Tea_GetDB().trackedItems[itemID] = true
