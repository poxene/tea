...
SlashCmdList["TEA"] = function(msg)
  ...
  if msg == "status" then
    ...
    Tea_Print("sell junk button: " .. OnOff(db.vendorTrash.showSellButton))
    ...
    Tea_Print("teaBank: " .. OnOff(db.modules.teaBank))
    Tea_Print("resourceBars: " .. OnOff(db.modules.resourceBars))
    Tea_Print("castBars: " .. OnOff(db.modules.castBars))
    Tea_Print("tooltip vendor price: " .. OnOff(db.tooltip.showVendorPrice))
    Tea_Print("tooltip item ID: " .. OnOff(db.tooltip.showItemId))
    Tea_Print("tooltip item level: " .. OnOff(db.tooltip.showItemLevel))
    Tea_Print("tooltip required level: " .. OnOff(db.tooltip.showRequiredLevel))
    Tea_Print("tooltip equip slot: " .. OnOff(db.tooltip.showEquipSlot))
    Tea_Print("tooltip item type: " .. OnOff(db.tooltip.showItemType))
    Tea_Print("tooltip max stack: " .. OnOff(db.tooltip.showMaxStack))
    Tea_Print("tooltip tracked marker: " .. OnOff(db.tooltip.showTracked))
